...
class AttackPokemon{
    ...
    public function __construct($attackMinimal, $attackMaximal, $specialAttack, $probabilitySpecialAttack) {
        ...
        { return "AttackMinimal: " . $this->attackMinimal . ", AttackMaximal: " . $this->attackMaximal . ", SpecialAttack: " . $this->specialAttack . ", ProbabilitySpecialAttack: " . $this->probabilitySpecialAttack;  }
