...
<body>
    ...
    <div>
        ...
        <form method="POST" action="test.php">
            ...
            <button name="submit4" type="submit">Add</button>
        </form>
        <?php
        ...
        <form method="POST" action="test.php">
            ...
            <button name="sup" type="submit">Delete</button>
        </form>
        <?php
        if (isset($_POST['sup'])) {
            $id = $_POST['id'];
    ...
    <div>
        ...
        <table border="1">
            ...
            <?php
            $repository = new Repository($cnx, 'section', 'id', ['designation', 'description']);
        ...
        <form method="POST" action="test.php">
            ...
            <button name="sub5" type="submit">Add</button>
        </form>
        <?php
        if (isset($_POST['sub5'])) {
            $id = $_POST['id'];
            ...
            $repository->create(['id' => $id, 'designation' => $designation , 'description' => $description]);
            echo "<p>section added successfully!</p>";
        }
        ?>
        ...
        <form method="POST" action="test.php">
            ...
            <input  name="id" required><br>
            <button name="sub6" type="submit">Delete</button>
        </form>
        <?php
        if (isset($_POST['sub6'])) {
            $id = $_POST['id'];
        ...
        ?>
        <h3>find a section by</h3>
        <form method="POST" action="test.php">
            <label for="id"> Section ID:</label>
            <input  name="id" required><br>
            <button name="sub7" type="submit">Find</button>
        </form>
        <?php
        if (isset($_POST['sub7'])) {
            $id = $_POST['id'];
            ...
            if ($section) {
                echo "<p>section found : " . htmlspecialchars($section['designation']) . "</p>";
            } else {
                echo "<p>no section found with this ID </p>";
            }
        }
        ?>
    </div>
